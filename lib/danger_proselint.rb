module Danger
  ...
  class DangerProselint < DangerPlugin
    ...
    def lint_files(files=nil)
      ...
      markdown_files = files ? Dir.glob(files) : (dangerfile.modified_files + dangerfile.added_files)
      ...
      current_branch = dangerfile.env.request_source.pr_json["head"]["ref"]
      current_slug = dangerfile.env.ci_source.repo_slug
